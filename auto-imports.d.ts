...
export {}
declare global {
  const Booking: typeof import('./src/models/Booking')['Booking']
  const Cap: typeof import('./src/models/Cap')['Cap']
  const Competition: typeof import('./src/models/Competition')['Competition']
  const Contract: typeof import('./src/models/Contract')['Contract']
  const EffectScope: typeof import('vue')['EffectScope']
  const Fixture: typeof import('./src/models/Fixture')['Fixture']
  const FixtureLeg: typeof import('./src/models/FixtureLeg')['FixtureLeg']
  const Goal: typeof import('./src/models/Goal')['Goal']
  const Injury: typeof import('./src/models/Injury')['Injury']
  const Loan: typeof import('./src/models/Loan')['Loan']
  const Match: typeof import('./src/models/Match')['Match']
  const PenaltyShootout: typeof import('./src/models/PenaltyShootout')['PenaltyShootout']
  const Player: typeof import('./src/models/Player')['Player']
  const PlayerHistory: typeof import('./src/models/PlayerHistory')['PlayerHistory']
  const Squad: typeof import('./src/models/Squad')['Squad']
  const SquadPlayer: typeof import('./src/models/SquadPlayer')['SquadPlayer']
  const Stage: typeof import('./src/models/Stage')['Stage']
  const Substitution: typeof import('./src/models/Substitution')['Substitution']
  const TableRow: typeof import('./src/models/TableRow')['TableRow']
  const Team: typeof import('./src/models/Team')['Team']
  const Transfer: typeof import('./src/models/Transfer')['Transfer']
  const User: typeof import('./src/models/User')['User']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly Booking: UnwrapRef<typeof import('./src/models/Booking')['Booking']>
    readonly Cap: UnwrapRef<typeof import('./src/models/Cap')['Cap']>
    readonly Competition: UnwrapRef<typeof import('./src/models/Competition')['Competition']>
    readonly Contract: UnwrapRef<typeof import('./src/models/Contract')['Contract']>
    readonly EffectScope: UnwrapRef<typeof import('vue')['EffectScope']>
    readonly Fixture: UnwrapRef<typeof import('./src/models/Fixture')['Fixture']>
    readonly FixtureLeg: UnwrapRef<typeof import('./src/models/FixtureLeg')['FixtureLeg']>
    readonly Goal: UnwrapRef<typeof import('./src/models/Goal')['Goal']>
    readonly Injury: UnwrapRef<typeof import('./src/models/Injury')['Injury']>
    readonly Loan: UnwrapRef<typeof import('./src/models/Loan')['Loan']>
    readonly Match: UnwrapRef<typeof import('./src/models/Match')['Match']>
    readonly PenaltyShootout: UnwrapRef<typeof import('./src/models/PenaltyShootout')['PenaltyShootout']>
    readonly Player: UnwrapRef<typeof import('./src/models/Player')['Player']>
    readonly PlayerHistory: UnwrapRef<typeof import('./src/models/PlayerHistory')['PlayerHistory']>
    readonly Squad: UnwrapRef<typeof import('./src/models/Squad')['Squad']>
    readonly SquadPlayer: UnwrapRef<typeof import('./src/models/SquadPlayer')['SquadPlayer']>
    readonly Stage: UnwrapRef<typeof import('./src/models/Stage')['Stage']>
    readonly Substitution: UnwrapRef<typeof import('./src/models/Substitution')['Substitution']>
    readonly TableRow: UnwrapRef<typeof import('./src/models/TableRow')['TableRow']>
    readonly Team: UnwrapRef<typeof import('./src/models/Team')['Team']>
    readonly Transfer: UnwrapRef<typeof import('./src/models/Transfer')['Transfer']>
    readonly User: UnwrapRef<typeof import('./src/models/User')['User']>
